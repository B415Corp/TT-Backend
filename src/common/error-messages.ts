export const ErrorMessages = {
  ...
  PROJECT_MEMBER_NOT_FOUND: 'У вас нет прав на изменение или удаление этого проекта',
  // Задачи
  ...
  // Подписка
  SUBSCRIPTION_TYPE_NOT_FOUND: (type: string) => `Тип подписки "${type}" не существует`,
  // Клиенты
  ...
  LATEST_TIME_LOG_NOT_FOUND: (id: string) => `Последняя временная отметка для задачи с ID "${id}" не найдена.`,
  ...
  // Ограничения
  USER_ROLE_LIMIT_EXCEEDED: 'Превышен лимит ролей пользователя для этого проекта',
  // Доступ
  ACCESS_FORBIDDEN: (roles: string) => `У вас нет разрешения на доступ к этому ресурсу. Необходимая роль: ${roles}`,
  // Ошибки тегов
